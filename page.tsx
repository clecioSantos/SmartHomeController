...
// Carregamento dinâmico do componente Responsive puro
...
export default function DashboardPage() {
  ...
  const [layout, setLayout] = useState([
    { i: 'dev-1', x: 0, y: 0, w: 2, h: 2 },
    { i: 'dev-2', x: 2, y: 0, w: 2, h: 2 },
  ]);
  ...
  const handleSaveDevice = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (editingDevice) {
      ...
      setLayout([...layout, { i: newId, x: 0, y: Infinity, w: 2, h: 2 }]);
    }
    closeModal();
  };
    ...
    <div className="p-6 lg:p-10 max-w-[1600px] mx-auto">
      ...
      <div ref={containerRef} className="w-full">
        ...
        {devices.map((device) => {
          ...
          return (
            <div key={device.id} className="bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col transition-colors">
              {/* Handle de Arrasto */}
              <div className="drag-handle p-4 pb-0 flex justify-between items-start cursor-grab active:cursor-grabbing">
